<?php
class GF_Drip_AddOnData{

    public static function update_table(){
        global $wpdb;
        $table_name = self::get_drip_table_name();
    ...
    public static function get_drip_table_name(){
        global $wpdb;
        return $wpdb->prefix . "rg_drip";
    }
    ...
    public static function drop_tables(){
        global $wpdb;
        $wpdb->query("DROP TABLE IF EXISTS " . self::get_drip_table_name());
    }
}