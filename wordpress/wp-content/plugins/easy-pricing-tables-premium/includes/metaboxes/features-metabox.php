<div id="dh_ptp_tabs_container" class="my_meta_control">
    <ul id="dh_ptp_metabox_tabs">
        <li class="dh_ptp_tab_header"><a href="#dh_ptp_tabs_2"><?php _e('Template', PTP_LOC); ?></a></li>
        <li class="dh_ptp_tab_header"><a href="#dh_ptp_tabs_1"><?php _e('Content', PTP_LOC); ?></a></li>
        <li class="dh_ptp_tab_header"><a href="#dh_ptp_tabs_3"><?php _e('Design', PTP_LOC); ?></a></li>
    </ul>
    ...
    <div style='display:none'>
        <div id='deploy' style='padding:10px; background:#fff;'>
            <p><?php _e('Copy the shortcode below and paste it wherever you want your pricing table to appear.', PTP_LOC); ?></p>
