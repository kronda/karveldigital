        ...
        <div class="tt-ptp-column zero">
            ...
            <ul class="ptp-settings explaination-settings">
                ...
                <li class="ptp-design4-content explaination-desc">
                    <strong><?php _e('Description', PTP_LOC); ?></strong><i class="ptp-icon-help-circled" data-trigger="hover" data-html="true" data-placement="right" data-original-title="&lt;strong&gt;<?php _e('Optional Description', PTP_LOC); ?>&lt;/strong&gt;" data-content="
                    <?php _e('Additional note on front part of pricing circle.', PTP_LOC); ?>
                                                                            "></i>
                </li>
                <li class="ptp-comparison-content explaination-desc ptp-billing-timeframe-content">
                    <strong><?php _e('Billing Timeframe', PTP_LOC); ?></strong><i class="ptp-icon-help-circled" data-trigger="hover" data-html="true" data-placement="right" data-original-title="&lt;strong&gt;<?php _e('Billing Timeframe', PTP_LOC); ?>&lt;/strong&gt;" data-content="
                    <?php _e('Specify a period for billing.', PTP_LOC); ?>
                                                                                  "></i>
                </li>
                ...
                <li class="ptp-comparison-content explaination-desc">
                    <?php $mb->the_field('comparison-table-features'); ?>
                    <?php
                    $placeholder = array(
                        str_pad(__('# of Website', PTP_LOC), 50),
                        str_pad(__('# of Visits', PTP_LOC), 50),
                        str_pad(__('Data Transfer', PTP_LOC), 50),
                        str_pad(__('Storage', PTP_LOC), 50),
                    );
                    ?>
                    <textarea name="<?php $mb->the_name(); ?>" class="form-control comparison1-textarea" rows="7" placeholder="<?php echo implode('', $placeholder); ?>"><?php echo $mb->the_value(); ?></textarea><br/>
                </li>
                <li class="ptp-standard-content explaination-desc">
                    <strong><?php _e('Button Text', PTP_LOC); ?></strong><i class="ptp-icon-help-circled" data-trigger="hover" data-html="true" data-placement="right" data-original-title="&lt;strong&gt;<?php _e('Call To Action Text', PTP_LOC); ?>&lt;/strong&gt;" data-content="
...
//        $checkIsExistMeta = get_post_meta(get_the_ID(), $id, TRUE);
    ...
    <?php $mb->the_field('planprice'); ?>
                        <input type="text" name="<?php $mb->the_name(); ?>" placeholder="<?php _e('e.g. $49/mo', PTP_LOC); ?>" value="<?php echo $mb->the_value(); ?>" class="form-control planprice">
                    </li>
                    <li class="ptp-design4-content">
    <?php $mb->the_field('optionaldescription'); ?>
                        <input type="text" name="<?php $mb->the_name(); ?>" placeholder="<?php _e('e.g. Per Month', PTP_LOC); ?>" value="<?php echo $mb->the_value(); ?>" class="form-control">
                    </li>
                    <li class="ptp-comparison-content ptp-billing-timeframe-content">
    <?php $mb->the_field('billingtimeframe'); ?>
                        <input type="text" name="<?php $mb->the_name(); ?>" placeholder="<?php _e('e.g. Monthly', PTP_LOC); ?>" value="<?php echo $mb->the_value(); ?>" class="form-control">
                    </li>
                    <li class="ptp-comparison-content ptp-billing-timeframe-content">
...
<?php endwhile; ?>
    ...
    <p class="ptp-comparison-content"><?php _e('<b>Note:</b> Use shortcodes [y] and [n] to use yes and no icons.', PTP_LOC); ?></p>
</div>