...
function dh_ptp_simple_flat_css($id, $meta)
{
    ...
    #ptp-<?php echo $id ?>  {
        border-color: <?php echo $design1_unfeatured_border_color; ?>;
        padding: 0px;
        margin-left: 0px;
        margin-right: 0px;
    }
    ...
    #ptp-<?php echo $id ?> .ptp-highlight div.ptp-item-container{
        border-color: <?php echo $design1_featured_border_color; ?>;
    }
    #ptp-<?php echo $id ?> div.ptp-plan {
        ...
        border-color: <?php echo $design1_title_area_background_color; ?>;
        background-color: <?php echo $design1_title_area_background_color; ?>;
    ...
    #ptp-<?php echo $id ?> .ptp-highlight div.ptp-plan{
        border-color: <?php echo $design1_featured_title_background_color; ?>;
        background-color: <?php echo $design1_featured_title_background_color; ?>;
        color: <?php echo $design1_featured_title_font_color; ?>;
    }
    #ptp-<?php echo $id ?> .ptp-highlight div.ptp-plan .has-tip {
        border-bottom: dotted 1px <?php echo $design1_featured_title_font_color; ?>;
        color: <?php echo $design1_featured_title_font_color; ?>;
    }
    #ptp-<?php echo $id ?> div.ptp-price{
        font-size: <?php echo $design1_price_font_size . $design1_price_font_size_type; ?>;
        background-color: <?php echo $design1_pricing_background_color; ?>;
        color: <?php echo $design1_pricing_area_font_color; ?>;
        padding: 0.9375em 1.25em;
    }
    #ptp-<?php echo $id ?> div.ptp-price .has-tip {
        border-bottom: dotted 1px <?php echo $design1_pricing_area_font_color; ?>;
        color: <?php echo $design1_pricing_area_font_color; ?>;
    }
    #ptp-<?php echo $id ?> .ptp-highlight div.ptp-price{
        background-color: <?php echo $design1_featured_pricing_background_color; ?>;
        color: <?php echo $design1_featured_pricing_font_color; ?>;
    }
    #ptp-<?php echo $id ?> .ptp-highlight div.ptp-price .has-tip {
        border-bottom: dotted 1px <?php echo $design1_featured_pricing_font_color; ?>;
        color: <?php echo $design1_featured_pricing_font_color; ?>;
    }
    #ptp-<?php echo $id ?> div.ptp-cta{
        ...
        background-color: <?php echo $design1_unfeatured_button_area_background_color; ?>;
        padding-top: 1.25em;
        padding-bottom: 1.25em;
    }
    #ptp-<?php echo $id ?> .ptp-highlight div.ptp-cta{
        background-color: <?php echo $design1_featured_button_area_background_color; ?>;
    }
    ...
    #ptp-<?php echo $id ?> a.ptp-button .has-tip, #ptp-<?php echo $id ?> a.ptp-button:hover .has-tip {
        border-bottom: dotted 1px <?php echo $design1_button_font_color; ?>;
        color: <?php echo $design1_button_font_color; ?>;
    }
    #ptp-<?php echo $id ?> a.ptp-button:hover{
        <?php if ($design1_shake_buttons_on_hover) : ?>
            margin-top: 2px;
            border-bottom: <?php echo $design1_button_border_color; ?> 2px solid;
        <?php else : ?>
            background-color: <?php echo $design1_button_hover_color; ?>;
        <?php endif; ?>
    }
    #ptp-<?php echo $id; ?> div.ptp-bullet-item {
        color: <?php echo $design1_featured_font_color; ?>;
        background-color: <?php echo $design1_featured_background_color; ?>;
        font-size: <?php echo $design1_bullet_item_font_size . $design1_bullet_item_font_size_type; ?>;
        border-color: <?php echo $design1_unfeatured_border_color; ?>;
        padding: 0.9375em 0.5em 0.9375em 0.5em;
    }
    #ptp-<?php echo $id; ?> div.ptp-bullet-item .has-tip, #ptp-<?php echo $id; ?> .ptp-bullet-item .has-tip:hover {
        color: <?php echo $design1_featured_font_color; ?>;
        border-bottom: dotted 1px <?php echo $design1_featured_font_color; ?>;
    }
    #ptp-<?php echo $id; ?> div.ptp-bullet-item .has-tip:hover {
        border-bottom: dotted 1px <?php echo $design1_featured_font_color; ?>;
    }
    #ptp-<?php echo $id; ?> .ptp-highlight .ptp-bullet-item {
        color: <?php echo $design1_featured_feature_color; ?>;
        border-color: <?php echo $design1_featured_border_color; ?>;
        background-color: <?php echo $design1_featured_feature_background_color; ?>;
    }
    ...
    #ptp-<?php echo $id ?> .ptp-highlight a.ptp-button:hover{
        <?php if ($design1_shake_buttons_on_hover) : ?>
            margin-top: 2px;
            border-bottom: <?php echo $design1_featured_button_border_color; ?> 2px solid;
        <?php else : ?>
            background-color: <?php echo $design1_featured_button_hover_color; ?>;
        <?php endif; ?>
    }
    #ptp-<?php echo $id; ?> .ptp-highlight a.ptp-button .has-tip {
        border-bottom: dotted 1px <?php echo $design1_featured_button_font_color; ?>;
        color: <?php echo $design1_featured_button_font_color; ?>;
    }
    #ptp-<?php echo $id ?> div.ptp-most-popular{
        ...
        background-color: <?php echo $design1_most_popular_area_background_color; ?>;
        color: <?php echo $design1_most_popular_font_color; ?>;
        border: 1px solid <?php echo $design1_featured_feature_label_border_color; ?>;
    }
...
function dh_ptp_generate_simple_flat_pricing_table_html ($id, $hide = false)
{
    ...
    foreach ($meta['column'] as $column) {
        ...
        if (!isset($meta['hide-call-to-action-buttons']) || !$meta['hide-call-to-action-buttons']) {
            ...
            $call_to_action =
                '<div class="ptp-cta">' .
                    (($custom_button)?$custom_button:'<a class="ptp-button" id="ptp-'.$id.'-cta-'.$loop_index.'"  href="' . $button_url . '" ' . $open_in_new_tab . ' '.$onclick.'>' . dh_ptp_fa_icons($button_text) . '</a>') .
	  			'</div>';
        }
        ...
        $pricing_table_html .= 
            '<div class="ptp-col ' . dh_ptp_get_number_of_columns() . ' '. $feature . ' ptp-col-id-' . $loop_index . ' dh-ptp-col-id-' . $loop_index . '">' .
                ...
                '<div class="ptp-item-container">'.
                    '<div class="ptp-plan">' . dh_ptp_fa_icons($plan_name) . '</div>' . 
                    '<div class="ptp-price">' . dh_ptp_fa_icons($plan_price) . '</div>' .
...
function dh_ptp_features_to_html_simple_flat ($plan_features, $max_number_of_features, $hide_empty_rows)
{
    ...
    for ($i=0; $i<$max_number_of_features; $i++) {
        if ($i < $this_columns_number_of_features &&  trim($features[$i]) != '') {
            $html .= '<div class="ptp-bullet-item ptp-row-id-'.$i.'">' . dh_ptp_fa_icons($features[$i]) . '</div>';
        } else {
           if (!$hide_empty_rows) {
