...
class TTFMP_Text_Column_Layout {
	...
	public function filter_column_layout_input( $wrap, $args ) {
		if ( isset( $args['name'] ) && 'text-column-layout-blurb' === $args['name'] ) {
			$blurb = __( 'Looking for the Column Layout option? Now you can simply click and drag the blue bars between the columns to change their grid layout. (2- and 3-column sections only.)', 'make-plus' );
