	...
	public function load_components() {
		...
		$components = array(
			...
			'edd' => array(
				...
				'conditions' => array(
					defined( 'TTFMAKE_VERSION' ) && true === version_compare( TTFMAKE_VERSION, '1.0.6', '>=' ), // Make sure the theme is >= 1.0.6
					in_array( 'easy-digital-downloads/easy-digital-downloads.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ), // Make sure Easy Digital Downloads is installed and activated
				)
			),
			'per-page'    => array(
				'slug'       => 'per-page',
