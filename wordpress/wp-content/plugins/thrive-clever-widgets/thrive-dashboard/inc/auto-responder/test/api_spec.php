...
//$mandrill = new Thrive_Dash_Api_Mandrill($mandrill_key);
//$message = array(
...
//
//$api = new Thrive_Dash_Api_AWeber($consumerKey, $consumerSecret);
//
...
//
//$gr = new Thrive_Dash_Api_GetResponse($get_response_key);
//var_dump($gr->getCampaigns());

//$aweber = Thrive_Dash_List_Manager::connectionInstance('aweber');
...
//$iContact = Thrive_Dash_Api_IContact::getInstance()->setConfig(array(
...
//$client = new Thrive_Dash_Api_GoToWebinar($apiKey, 'PSE8cZMgmn74worrWM30G5JHlrBC', '200000000000015219');
...
//$client = new Thrive_Dash_Api_ActiveCampaign('https://radutest.api-us1.com', 'a39d6bce4cc1581219c34dd2abae0daca504426a933b66ec92b877708d266efc7cf5a49f');
//$client->getLists();
//var_dump($client->addSubscriber(1, 'radu.groza@bitstone.eu', 'Radu', 'Groza', '07235785345'));
//
///** @var Thrive_Dash_List_Connection_iContact $iContact */
//$iContact = Thrive_Dash_List_Manager::connectionInstance('icontact');
