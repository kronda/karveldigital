    ...
    <script type="text/template" id="tve-leads-dashboard">
        ...
        <# if (has_non_uniques) { #>
            ...
            <div class="tve-group-list-header collapse-table-header hide-no-groups" style="display: none">
                ...
                <span class="tve-group-part collapse-table-part tve-group-center collapse-table-part-center"><?php echo __('Impressions', 'thrive-leads') ?></span>
                ...
                <div class="tve-collapse-table" id="tve-one-click-signup">
                    ...
                    <div class="tve-one-click-signup-list-header tve-shortcode-header collapse-table-header-condensed collapse-table-header"
                         style="display: none">
                        <span class="tve-group-part collapse-table-part tve-group-title collapse-table-part-title">&nbsp;</span>
                        <span class="tve-group-part collapse-table-part tve-group-center collapse-table-part-center"><?php echo __('Signups', 'thrive-leads') ?></span>
                        <span class="tve-group-part collapse-table-part tve-group-center collapse-table-part-center"><?php echo __('Service', 'thrive-leads') ?></span>
                        <span class="tve-group-part collapse-table-part tve-group-center collapse-table-part-center">&nbsp;</span>
                    </div>
                    ...
                    <div class="no-one-click-signup">
                        ...
                        <a href="//fast.wistia.net/embed/iframe/mv9an37krm?popover=true" class="wistia-popover[height=450,playerColor=2bb914,width=800]"><img src="<?php echo  TVE_LEADS_ADMIN_URL . "img/video-thumb-signup-segue.png" ?>" alt=""/></a>
                    </div>
                </div>
    </script>
</div>
