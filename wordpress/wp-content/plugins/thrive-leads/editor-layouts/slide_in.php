...
<div id="tve-leads-editor-replace">
    <div class="tve-leads-template-description" style="opacity: .6; margin: 0 auto;text-align: center; max-width: 80%;padding: 10px 0;">
    ...
    ?>
    <div class="tve-leads-slide-in tl_<?php echo $parent['position']; ?>">
...
<?php if (empty($is_ajax_render)) : ?>
    <div id="tve_page_loader" style="display: none" class="tve_page_loader">
