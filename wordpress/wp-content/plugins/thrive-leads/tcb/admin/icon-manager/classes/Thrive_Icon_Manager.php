    ...
    class Thrive_Icon_Manager
    {
        ...
        public function handlePost()
        {
            ...
            if (isset($success)) {
                ...
                $this->messages['redirect'] = admin_url('admin.php?page=thrive_icon_manager');
            }
        }
        ...
        protected function enqueue()
        {
            ...
            wp_enqueue_media();
            wp_enqueue_script('thrive_icon_manager_options', tve_editor_url() . '/admin/icon-manager/views/js/manager.js', array('jquery', 'media-upload', 'thickbox'));
            wp_enqueue_style('thrive_icon_manager_style', tve_editor_url() . '/admin/icon-manager/views/css/manager.css');
        }
