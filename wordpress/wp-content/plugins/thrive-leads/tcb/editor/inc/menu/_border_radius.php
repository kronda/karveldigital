<li class="tve_text tve_slider_config<?php echo !empty($li_class) ? ' ' . $li_class : ''; unset($li_class) ?>"
    data-value="0"
    data-min-value="0"
    data-property="border-radius"
    data-max-value="<?php echo isset($max_width) ? $max_width : 200; unset($max_width) ?>"
