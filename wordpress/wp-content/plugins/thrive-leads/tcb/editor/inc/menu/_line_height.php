<li class="tve_btn_text">
    <?php $line_height_label = empty($line_height_label) ? 'Line height' : $line_height_label ?>
...
<li class="tve_ed_btn tve_btn_text">
    <div class="tve_option_separator">
        <span class="tve_ind tve_left line-height-unit" data-default="Pixels">Pixels</span><span
        ...
        <div class="tve_sub_btn">
            <div class="tve_sub active_sub_menu">
                <ul>
                    <li id="tve_line_height_px" class="tve_click tve_line_height_unit">Pixels</li>
...
<li class="tve_ed_btn tve_btn_text tve_click" id="tve_clear_line_height">Clear line height</li>