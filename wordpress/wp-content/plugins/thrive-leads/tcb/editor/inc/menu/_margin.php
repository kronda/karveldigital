<li class="tve_ed_btn tve_btn_text tve_firstOnRow<?php if (isset($btn_class)) echo ' ' . $btn_class;
unset($btn_class) ?>">
    <div class="tve_option_separator">
        <span class="tve_ind tve_left"><?php if (!empty($margin_prefix)) : echo $margin_prefix;
                unset($margin_prefix); endif; ?>
            Margins<?php if (empty($margin_config['hide_padding'])) : ?> & Paddings<?php endif ?></span><span
            ...
            <div class="tve_sub active_sub_menu tve_large tve_dark tve_clearfix"
                ...
                <ul style="width: 150px;">
                    ...
                    <?php if (empty($margin_right_hide)) : ?>
                        <li class="tve_no_hover tve_no_click"><label class="tve_text"><span
                                    class="tve_label_spacer tve_small">Right: </span><input
                                    id="tve_margin_top" type="text" class="margin-control tve_change"
                    ...
                    <li id="tve_margin_clear"
                        class="tve_no_hover tve_no_click tve_ed_btn tve_ed_btn_text tve_click tve_center "
                        style="text-align: center;">Clear margins
                    </li>
                </ul>
                <?php if (empty($margin_config['hide_padding'])) : ?>
                    ...
                    <ul style="width: 150px;">
                        ...
                        <li id="tve_padding_clear"
                            class="tve_no_hover tve_no_click tve_ed_btn tve_ed_btn_text tve_click tve_center "
                            style="text-align: center;">Clear paddings
                        </li>
                    </ul>
                <?php endif ?>
            </div>
