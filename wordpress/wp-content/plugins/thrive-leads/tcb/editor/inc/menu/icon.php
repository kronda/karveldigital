<span class="tve_options_headline"><span class="tve_icm tve-ic-move"></span>Icon options</span>
<ul class="tve_menu">
    ...
    <li class="tve_ed_btn tve_btn_text tve_center tve_click tve_icon_align tve_firstOnRow tve_hide_cb" data-cls="">None</li>
    ...
    <li class="tve_text tve_slider_config tve_firstOnRow tve_hide_cb" data-value="30" data-min-value="10"
        ...
        <label for="icon_size_input" class="tve_left">&nbsp;Icon size</label>
    ...
    <li class="tve_text tve_slider_config tve_firstOnRow tve_hide_cb" data-value="0" data-min-value="0"
        ...
        <label for="icon_padding_input" class="tve_left">&nbsp;Padding size</label>
    ...
    <li id="lb_icon" data-load="1" data-wpapi="lb_icon"
        class="tve_ed_btn tve_btn_text tve_btn tve_click tve_icon_ctrl" data-ctrl="controls.lb_open">Change Icon
    </li>
    <li class="tve_text tve_text_ctrl">
        <label class="tve_left">Icon text &nbsp;</label><input class="tve_change tve_left" id="tve_icon_text" type="text" data-ctrl="controls.change.icon_text" placeholder="Icon text" value="1" size="2">
    </li>
    <li class=""><input type="text" class="element_class tve_change" data-ctrl="controls.change.cls" placeholder="Custom class"></li>

    <?php $li_custom_class = 'tve_hide_cb'; include dirname(__FILE__) . '/_event_manager.php' ?>
