...
<ul class="tve_menu">
    ...
    ?>
    <?php $has_custom_colors = true; $hide_default_colors = true; include dirname(__FILE__) . '/_custom_colors.php' ?>
    ...
    <li class="tve_ed_btn_text tve_firstOnRow responsive_video_option" data-apply-to="[wistia]" data-multiple-hide>
        <label class="tve_text">
    ...
    <li class="tve_ed_btn_text" data-multiple-hide>
    ...
    <li class="clearfix responsive_video_option tve_ed_btn_text" data-apply-to="[youtube|wistia]" data-multiple-hide>
    ...
    <li class="clearfix responsive_video_option tve_ed_btn_text" data-apply-to="[wistia]" data-multiple-hide id="tve_thumbnail_size_options">
        <label for="" class="tve_text">
