...
<ul class="tve_menu">
    ...
    <?php
    $extra_attr = 'data-apply-to="[wistia|vimeo]" data-multiple-hide';
    ...
    <li class="tve_text clearfix responsive_video_option" data-apply-to="[youtube]" data-multiple-hide>
    ...
    <li class="tve_text clearfix responsive_video_option" data-apply-to="[youtube|wistia|vimeo]" data-multiple-hide>
