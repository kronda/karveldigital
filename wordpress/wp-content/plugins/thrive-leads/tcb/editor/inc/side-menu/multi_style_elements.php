...
<div class="tve_cpanel_list">
        ...
        <div class="tve_sub_btn" title="<?php echo __("Content Box", "thrive-cb") ?>">
            <div class="tve_sub">
                <ul>
                    ...
                    <li class="cp_draggable sc_contentbox1" data-elem="sc_contentbox1"><div class="tve_icm tve-ic-plus"></div><?php echo sprintf(__("Style %s", "thrive-cb"), "1") ?></li>
                    <li class="cp_draggable sc_contentbox2" data-elem="sc_contentbox2"><div class="tve_icm tve-ic-plus"></div><?php echo sprintf(__("Style %s", "thrive-cb"), "2") ?></li>
                    <li class="cp_draggable sc_contentbox3" data-elem="sc_contentbox3"><div class="tve_icm tve-ic-plus"></div><?php echo sprintf(__("Style %s", "thrive-cb"), "3") ?></li>
                    <li class="tve_sub_heading"><?php echo __("Without Headline", 'thrive-cb') ?></li>
                    <li class="cp_draggable sc_contentbox4" data-elem="sc_contentbox4"><div class="tve_icm tve-ic-plus"></div><?php echo sprintf(__("Style %s", "thrive-cb"), "4") ?></li>
                    <li class="cp_draggable sc_contentbox5" data-elem="sc_contentbox5"><div class="tve_icm tve-ic-plus"></div><?php echo sprintf(__("Style %s", "thrive-cb"), "5") ?></li>
                    <li class="cp_draggable sc_contentbox6" data-elem="sc_contentbox6"><div class="tve_icm tve-ic-plus"></div><?php echo sprintf(__("Style %s", "thrive-cb"), "6") ?></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="tve_option_separator tve_clearfix" title="<?php echo __("Symbol Box", 'thrive-cb') ?>">
        ...
        <div class="tve_sub_btn">
            <div class="tve_sub">
                <ul>
                    <li class="cp_draggable" data-elem="sc_contentbox_icon"><div class="tve_icm tve-ic-plus"></div><?php echo __("Icon Box", 'thrive-cb') ?></li>
                    <li class="cp_draggable" data-elem="sc_contentbox_text"><div class="tve_icm tve-ic-plus"></div><?php echo __("Number Box", "thrive-cb") ?></li>
                </ul>
            </div>
        </div>
    </div>
