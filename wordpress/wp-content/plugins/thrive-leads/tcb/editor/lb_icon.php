    ...
    <div class="icomoon-icon-list">
        ...
        <?php if (!empty($icon_data['icons'])) : ?>
            <?php foreach ($icon_data['icons'] as $class) : ?>
                <span<?php if (!empty($icon_click)) echo ' data-ctrl="' . $icon_click . '"' ?> class="icomoon-icon<?php echo ($class == $selected) ? ' tve_selected' : '' ?><?php if (!empty($icon_click)) echo ' tve_click' ?>" title="<?php echo $class ?>" data-cls="<?php echo $class ?>">
