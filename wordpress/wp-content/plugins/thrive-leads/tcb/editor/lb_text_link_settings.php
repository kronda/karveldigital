<div class="tve-hyperlinks-lightbox-wrapper">
    ...
    <div class="tve-lightbox-settings-wrapper">
        ...
        <ul>
            ...
            $exceptionList = apply_filters('tve_post_types_blacklist', array('attachment', 'focus_area', 'thrive_optin', 'wysijap', 'revision', 'nav_menu_item', 'tve_lead_shortcode', 'tve_lead_1c_signup', 'tve_form_type', 'tve_lead_group'));
