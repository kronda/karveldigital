...
<p>You sign up form is connected to service(s) using the following API connections:</p>
...
<?php endif ?>
<div class="tve_clear" style="height:10px;"></div>
<p>Select which fields to display and their properties (you can reorder them by dragging the "move" icon from the left):</p>
<?php
