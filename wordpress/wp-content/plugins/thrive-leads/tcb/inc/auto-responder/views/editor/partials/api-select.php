<div id="thrive-api-connections">
    ...
    <?php if (empty($connected_apis)) : ?>
        <p>You currently don't have any API integrations set up.</p>
        <div class="tve_clear" style="height:20px;"></div>
        <p><a href="<?php echo admin_url('admin.php?page=tve_api_connect') ?>" target="_blank">Click here to set up a new API connection</a></p>
    <?php else : ?>

        <p>Choose from your list of existing API connections or <a href="<?php echo admin_url('admin.php?page=tve_api_connect') ?>" target="_blank">add a new integration</a></p>
