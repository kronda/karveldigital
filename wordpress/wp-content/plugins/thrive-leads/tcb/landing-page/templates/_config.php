...
return array(
    ...
    'phonic-email-confirmation-page' => array(
        ...
        'icons' => array(
            'phonic-icon-arrow', 'phonic-icon-email-download', 'phonic-icon-email-open', 'phonic-icon-email-click'
        ),
        'hidden_menu_items' => array(
            'max_width', 'bg_full_height', 'border_radius'
        ),
    ...
    'phonic-podcast-itunes' => array(
        ...
        'icons' => array(
            'phonic-icon-arrow', 'phonic-icon-arrowright'
        ),
        'has_lightbox' => true,
        'lightbox' => array(
            'max_width' => '760px',
    ...
    'phonic-universal-podcast' => array(
        ...
        'icons' => array(
            'phonic-icon-arrow', 'thrv-icon-forward'
        ),
        'has_lightbox' => true,
        'lightbox' => array(
            'max_width' => '760px',
    ...
    'confluence-thank-you' => array(
        ...
        'icons' => array(
            'confluence-icon-edit', 'confluence-icon-calendar', 'confluence-icon-bell'
        ),
        'style_family' => 'Minimal',
    ),
    'confluence-thank-you-download' => array(
        ...
        'icons' => array(
            'confluence-icon-edit', 'confluence-icon-calendar', 'confluence-icon-bell', 'confluence-icon-pdf'
        ),
        'style_family' => 'Minimal',
    ),
    'review-page' => array(
    ...
    'review-video-recommendation-page' => array(
        ...
        'style_family' => 'Flat',
        'icons' => array(
            'review-page-icon-gear', 'review-page-icon-download', 'review-page-icon-files', 'review-page-icon-tools', 'review-page-icon-atom', 'review-page-icon-arrow'
        ),
    ),
    ...
    'video-course-email-confirmation2' => array(
        ...
        'icons' => array(
            'video-course-icon-arrow', 'video-course-icon-goto', 'video-course-icon-open', 'video-course-icon-click'
        ),
        'style_family' => 'Classy',
    ),
    'video-course-lead-generation' => array(
        ...
        'icons' => array(
            'video-course-icon-arrow', 'video-course-icon-play'
        ),
        'has_lightbox' => true,
        'lightbox' => array(
            'max_width' => '515px',
    ...
    'edition-author-lead-generation' => array(
        ...
        'icons' => array(
            'edition-icon-gear', 'edition-icon-globe', 'edition-icon-monitor', 'edition-icon-lock'
        ),
        'style_family' => 'Classy',
        'has_lightbox' => true,
        'lightbox' => array(
    ...
    'edition-book-landing-page' => array(
        ...
        'icons' => array(
            'edition-icon-download', 'edition-icon-arrow', 'edition-icon-atom', 'edition-icon-comments'
        ),
        'style_family' => 'Classy',
    ),
    ...
    'corp-app-landing-page' => array(
        ...
        'icons' => array(
            'corp-icon-clock', 'corp-icon-leaf', 'corp-icon-hat', 'corp-icon-ribbon'
        ),
        'has_lightbox' => true,
        'lightbox' => array(
            'max_width' => '720px',
