        ...
        <?php foreach ($posts as $key => $post): ?>
            ...
            <?php endif; ?>
                <div class="tve_post tve_post_width_<?php echo $config['columns'] ?> <?php echo $this->postGridClasses($index)?>">
                    <div class="tve_pg_container" <?php echo $custom_item_container?>>
                        <?php foreach ($config['layout'] as $call) : ?>
                            <?php if (isset($config['teaser_layout'][$call]) && $config['teaser_layout'][$call] === 'true') : ?>
                                ...
                                <?php
                                switch ($callable) {
                                    case 'tve_post_grid_display_post_featured_image':
                                        echo $this->tve_post_grid_display_post_featured_image($post, $config);
                                        break;
