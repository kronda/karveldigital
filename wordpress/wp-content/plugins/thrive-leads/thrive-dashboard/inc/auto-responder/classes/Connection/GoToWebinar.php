...
//    const APPLICATION_CONSUMER_KEY = 'Mtm8i2IdR2mOkAY3uVoW5f4TdGaBxpkY';
    ...
    public function getWarnings()
    {
        ...
        $fix = '<a href="' . admin_url('admin.php?page=tve_dash_api_connect&api=' . $this->getKey()) . '#tve-list-setup-' . $this->getKey() . '">' . __('Renew the token', TVE_DASH_TRANSLATE_DOMAIN) . '</a>';
        $dismiss = '<a href="javascript:void(0)" class="tve-api-dismiss" data-key="' . $this->getKey() . '">' . __('don\'t show this message again', TVE_DASH_TRANSLATE_DOMAIN) . '</a>';
