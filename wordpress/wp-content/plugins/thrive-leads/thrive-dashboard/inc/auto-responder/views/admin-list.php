...
<div class="tvd-preloader-overlay tvd-page-preloader" id="tvd-hide-onload">
    ...
    <div class="tvd-row">
        ...
        <div class="tvd-col tvd-s12 tvd-m6">
            <a href="<?php echo admin_url('admin.php?page=tve_dash_api_error_log'); ?>"
               class="tvd-waves-effect tvd-waves-light tvd-btn-small tvd-btn-red tvd-right">
                <?php echo __("Error Logs", TVE_DASH_TRANSLATE_DOMAIN); ?>
            </a>
        </div>
    </div>
</div>
...
<script type="text/template" id="tvd-api-state-form">
    <div class="tvd-card tvd-gray tvd-disabled">
        <div class="tvd-card-content"></div>
    </div>
</script>
...
<script type="text/template" id="tvd-api-state-error">
    <div class="tvd-card tvd-orange">
        <div class="tvd-card-content">
            ...
            <div class="tvd-row">
                <div class="tvd-col tvd-s12 tvd-m6">
                    <a class="tvd-api-cancel tvd-btn-flat tve-btn-flat-secondary tve-btn-flat-light "><?php echo __("Cancel", TVE_DASH_TRANSLATE_DOMAIN) ?></a>
                </div>
                <div class="tvd-col tvd-s12 tvd-m6">
                    <a class="tvd-api-retry tvd-btn-flat tve-btn-flat-primary tve-btn-flat-light"><?php echo __("Retry", TVE_DASH_TRANSLATE_DOMAIN) ?></a>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/template" id="tvd-api-state-success">
    <div class="tvd-card tvd-green tvd-medium">
        <div class="tvd-card-content tvd-center-align">
            ...
            <p>
                <?php echo __("You can now connect your opt-in forms to ", TVE_DASH_TRANSLATE_DOMAIN) ?><#= item.get('title') #>.
            ...
            <div class="tvd-row">
                <div class="tvd-col tvd-s12 tvd-m6 tvd-offset-m3">
                    <a href="javascript:void(0)"
                       class="tvd-api-done tvd-btn-flat tve-btn-flat-primary tve-btn-flat-light tvd-full-btn tvd-btn-margin-top"><?php echo __("Done", TVE_DASH_TRANSLATE_DOMAIN) ?></a>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/template" id="tvd-api-connection-error">
    <div class="tvd-card tvd-orange tvd-valign-wrapper">
        <div class="tvd-card-content tvd-valign tvd-center-align">
            ...
            <a class="tvd-btn-flat tve-btn-flat-primary tve-btn-flat-light tvd-api-edit">
...
<script type="text/template" id="tvd-api-confirm-delete">
    <div class="tvd-card tvd-small tvd-red">
        ...
        <div class="tvd-card-action">
            <div class="tvd-row">
                <div class="tvd-col tvd-s12 tvd-m6">
                    <a class="tvd-api-delete-yes tvd-btn-flat tve-btn-flat-secondary tve-btn-flat-light tvd-left"
                       href="javascript:void(0)">
                        <?php echo __("Yes, delete", TVE_DASH_TRANSLATE_DOMAIN) ?>
                    </a>
                </div>
                <div class="tvd-col tvd-s12 tvd-m6">
                    <a class="tvd-api-delete-no tvd-btn-flat tve-btn-flat-primary tve-btn-flat-light tvd-right">
