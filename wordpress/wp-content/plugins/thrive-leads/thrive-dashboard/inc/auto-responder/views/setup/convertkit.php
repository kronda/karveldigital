...
<div class="tvd-row">
    <form class="tvd-col tvd-s12">
        ...
        <div class="tvd-input-field">
            <input id="tvd-ck-api-url" type="text" name="connection[key]" value="<?php echo $this->param('key') ?>">
            <label for="tvd-ck-api-url"><?php echo __("API key", TVE_DASH_TRANSLATE_DOMAIN) ?></label>
        </div>
    </form>
</div>
<div class="tvd-row">
