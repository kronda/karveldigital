...
<div class="tvd-row">
	<form class="tvd-col tvd-s12">
		...
		<div class="tvd-input-field">
			...
			<label for="tvd-sr-api-key"><?php echo __( "Key", TVE_DASH_TRANSLATE_DOMAIN ) ?>:</label>
		</div>
		<div class="tvd-input-field">
			<input id="tvd-sr-api-secret" type="text" name="connection[secret]"
			       value="<?php echo $this->param( 'secret' ) ?>">
			<label for="tvd-sr-api-secret"><?php echo __( "Secret", TVE_DASH_TRANSLATE_DOMAIN ) ?>:</label>
		</div>
	</form>
</div>
<div class="tvd-row">
