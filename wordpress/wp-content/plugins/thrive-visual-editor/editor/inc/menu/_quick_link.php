...
<li class="tve_btn_text<?php if (isset($btn_class)) echo ' ' . $btn_class;unset($btn_class) ?> tve_quick_link_input_holder" data-multiple-hide>
    ...
    <div class="tve_option_separator">
        ...
        <span class="tve_button_disabled tve_lb_small tve_icm tve-ic-chain" id="lb_text_link"
              title="<?php echo __("Create link", "thrive-cb") ?>"></span>
        <input  style="float:right" class="tve_button_disabled tve_text tve_keyup tve_mousedown tve_quick_link_input" data-ctrl="controls.quick_link.updateContentList" type="text" data-ctrl-mousedown="controls.save_selection" data-key="linkSel" placeholder="Search or type URL"/>
