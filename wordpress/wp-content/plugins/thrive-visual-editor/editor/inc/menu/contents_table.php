<span class="tve_options_headline"><span class="tve_icm tve-ic-move"></span>Table of Contents options</span>
<ul class="tve_menu">
    <?php $has_custom_colors = true; include dirname(__FILE__) . '/_custom_colors.php' ?>
    <?php include dirname(__FILE__) . '/_margin.php' ?>
    <li>
        <div id="tve_update_contents_table" class="tve_ed_btn tve_btn_text tve_center btn_alignment tve_left tve_click">Update</div>
    </li>
    ...
    <li>
        <label>
            Min-width <input id="ct_min_width" class="tve_text tve_change" type="text" size="4" maxlength="4"/> px
        </label>
    </li>
    <li>
        <label>
            Max-width <input id="ct_max_width" class="tve_text tve_change" type="text" size="4" maxlength="4"/> px
        </label>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div title="Text align left" class="tve_icm tve-ic-paragraph-left tve_click" data-cls="tve_p_left" data-ctrl="controls.click.text_align"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div title="Text align center" class="tve_icm tve-ic-paragraph-center tve_click" data-cls="tve_p_center" data-ctrl="controls.click.text_align"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div title="Text align right" class="tve_icm tve-ic-paragraph-right tve_click" data-cls="tve_p_right" data-ctrl="controls.click.text_align"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div title="Text align justify" class="tve_icm tve-ic-paragraph-justify tve_click" data-cls="tvealignjustify" data-ctrl="controls.click.text_align"></div>
    </li>
</ul>