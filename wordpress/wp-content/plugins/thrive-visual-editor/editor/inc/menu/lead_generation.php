...
<ul class="tve_menu tve_clearfix">
    ...
    <li>
        <label id="lead_generation_form_target" style="display: none !important;">
            ...
            <div class="tve_sub_btn">
                <div class="tve_sub active_sub_menu tve_lg_errors tve_clearfix">
                    <ul>
                        ...
                        <li><div data-ctrl="function:controls.lead_generation.reset_errors" class="tve_ed_btn tve_btn_text tve_center tve_right tve_click tve_no_click"><?php echo __("Reset errors to default", "thrive-cb") ?></div></li>
                    </ul>
                </div>
            </div>
        </div>
