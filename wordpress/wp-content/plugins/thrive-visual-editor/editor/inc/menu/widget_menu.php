...
<ul class="tve_menu">
	...
	<li class="tve_ed_btn tve_btn_text">
		<a target="_blank" style="color: #47bb28" class="menu-edit-link" href="<?php echo $_POST['admin_url'] ?>nav-menus.php?action=edit&menu=" target="_blank"><?php echo __( "Edit menu", "thrive-cb" ) ?></a>
	</li>
