        ...
        <div class="tve_sub_btn" title="Content Box">
            <div class="tve_sub">
                <ul>
                    ...
                    <li class="cp_draggable sc_contentbox1" data-elem="sc_contentbox1"><div class="tve_icm tve-ic-plus"></div>Style 1</li>
                    <li class="cp_draggable sc_contentbox2" data-elem="sc_contentbox2"><div class="tve_icm tve-ic-plus"></div>Style 2</li>
                    <li class="cp_draggable sc_contentbox3" data-elem="sc_contentbox3"><div class="tve_icm tve-ic-plus"></div>Style 3</li>
                    <li class="tve_sub_heading">Without Headline</li>
                    <li class="cp_draggable sc_contentbox4" data-elem="sc_contentbox4"><div class="tve_icm tve-ic-plus"></div>Style 4</li>
                    <li class="cp_draggable sc_contentbox5" data-elem="sc_contentbox5"><div class="tve_icm tve-ic-plus"></div>Style 5</li>
                    <li class="cp_draggable sc_contentbox6" data-elem="sc_contentbox6"><div class="tve_icm tve-ic-plus"></div>Style 6</li>
                </ul>
            </div>
        </div>
    </div>
    <div class="tve_option_separator tve_clearfix" title="Symbol Box">
        <div class="tve_icm tve-ic-plus-square-o tve_left"></div>
        <span class="tve_expanded tve_left">Symbol Box</span>
        <span class="tve_caret tve_icm tve_right tve_sub_btn tve_expanded" id="sub_02"></span>
        ...
        <div class="tve_sub_btn">
            <div class="tve_sub">
                <ul>
                    <li class="cp_draggable" data-elem="sc_contentbox_icon"><div class="tve_icm tve-ic-plus"></div>Icon Box</li>
                    <li class="cp_draggable" data-elem="sc_contentbox_text"><div class="tve_icm tve-ic-plus"></div>Number Box</li>
                </ul>
            </div>
        </div>
    </div>
    <div class="tve_option_separator tve_clearfix">
        <div class="tve_icm tve-ic-share tve_left"></div>
        <span class="tve_expanded tve_left">Quote Share</span>
        <span class="tve_caret tve_icm tve_right tve_sub_btn tve_expanded"></span>

        <div class="tve_clear"></div>
        <div class="tve_sub_btn" title="Twitter Share 1">
            <div class="tve_sub">
                <ul>
                    <li class="cp_draggable sc_tw_quote_share1 tve_clearfix" data-elem="sc_tw_quote_share1">
                        <div class="tve_icm tve-ic-plus"></div>Twitter Share 1
                    </li>
                </ul>
            </div>
        </div>
