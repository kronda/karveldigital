...
abstract class Thrive_List_Connection_Abstract
{
    ...
    {
        Thrive_List_Manager::message($type, $message);
     ...
     *
     * @see Thrive_List_Manager
     *
     * @return Thrive_List_Connection_Abstract
     */
    public function save()
    {
        Thrive_List_Manager::save($this);
        return $this;
    }
