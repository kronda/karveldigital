...
<div class="tve_lp_header tve_empty_dropzone tve_content_width">
    <div class="thrv_wrapper thrv_page_section" data-tve-style="1" style="">
        <div class="out">
            <div class="in lightSec pddbg" style="background-image: url('<?php echo TVE_LANDING_PAGE_TEMPLATE . "/css/images/copy_sales_page_bg.jpg" ?>');
...
<div class="tve_lp_content tve_editor_main_content tve_empty_dropzone thrv_wrapper tve_no_drag" style="margin-top: 70px; max-width: 1080px; background-attachment: scroll;">
    ...
    <div style="width: 29px;" class="thrv_wrapper tve_image_caption aligncenter">
        <span class="tve_image_frame">
            <img class="tve_image" src="<?php echo TVE_LANDING_PAGE_TEMPLATE ?>/css/images/copy_red_arrow.png" style="width: 29px">
        </span>
    </div>
    ...
    <div class="thrv_wrapper thrv_columns tve_clearfix" style="margin-top: 50px;">
        ...
        <div class="tve_colm tve_twc tve_lst">
            <div style="width: 353px;" class="thrv_wrapper tve_image_caption aligncenter">
                <span class="tve_image_frame">
                    <img class="tve_image" src="<?php echo TVE_LANDING_PAGE_TEMPLATE ?>/css/images/copy_cd.png" style="width: 353px">
                </span>
            </div>
        </div>
    </div>
        ...
        <div class="tve_ts tve_ts-copy tve_red" style="margin-bottom: 10px;">
            ...
            <div class="tve_ts_o-copy">
                <div class="tve_ts_imc-copy">
                    <img class="tve_image" src="<?php echo TVE_LANDING_PAGE_TEMPLATE ?>/css/images/test1.png" alt="">
                </div>
    ...
    <div class="thrv_wrapper thrv_testimonial_shortcode" data-tve-style="10">
        <div class="tve_ts tve_ts-copy tve_red">
            ...
            <div class="tve_ts_o-copy">
                <div class="tve_ts_imc-copy">
                    <img class="tve_image" src="<?php echo TVE_LANDING_PAGE_TEMPLATE ?>/css/images/test2.png" alt="">
                </div>
                <span class="tve_ts_copy-aut">
                    <b>PAUL SCHMIDT</b>
                ...
                <div class="thrv_wrapper thrv_columns tve_clearfix">
                    <div class="tve_colm tve_foc tve_df tve_ofo">
                        <div style="width: 162px;" class="thrv_wrapper tve_image_caption aligncenter">
                            <span class="tve_image_frame">
                                <img class="tve_image" src="<?php echo TVE_LANDING_PAGE_TEMPLATE ?>/css/images/copy_guarantee.png" style="width: 162px">
                            </span>
                        </div>
                    </div>
    ...
    <div class="thrv_wrapper thrv_testimonial_shortcode" data-tve-style="10">
        <div class="tve_ts tve_ts-copy tve_red">
            ...
            <div class="tve_ts_o-copy">
                <div class="tve_ts_imc-copy">
                    <img class="tve_image" src="<?php echo TVE_LANDING_PAGE_TEMPLATE ?>/css/images/test3.png" alt="">
                </div>
                <span class="tve_ts_copy-aut">
                    <b>MARC JACOBS</b>
    ...
    <div style="width: 172px; margin-bottom: 20px;" class="thrv_wrapper tve_image_caption">
        <span class="tve_image_frame">
            <img class="tve_image" src="<?php echo TVE_LANDING_PAGE_TEMPLATE ?>/css/images/signature.png" style="width: 172px">
        </span>
    </div>
    <div class="thrv_wrapper">
