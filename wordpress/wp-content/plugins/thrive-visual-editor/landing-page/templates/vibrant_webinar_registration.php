...
<h1 class="tve_p_center" style="font-size: 63px;margin-top: 0;">Author Reveals... <font color="#f58000">5 Simple
                                            ...
                                            <div class="tve_cb_cnt">
                                                <div class="thrv_wrapper thrv_columns" style="margin: 0;">
                                                    ...
                                                    <div class="tve_colm tve_twc tve_lst">
                                                        <h4 class="vibrant_webinar_heading" style="font-size: 30px; margin-top: 10px;margin-bottom:0px;">
                                                            <font color="#f58000">*FREE LIVE*</font>
                                                        </h4>
                                                        <h4 class="vibrant_webinar_heading" style="color: #333333;font-size: 30px; margin-top: 0px;margin-bottom: 40px;">
                                                            &nbsp;&nbsp;WEBINAR</h4>
                                                        <p class="vibrant_webinar_heading" style="color: #333333;margin-left: 5px;margin-bottom: 20px;">
                                                            With <span class="bold_text">Steve Blake</span></p>
                ...
                <div class="thrv_wrapper thrv_content_container_shortcode">
                    ...
                    <div class="tve_center tve_content_inner" style="width: 950px;min-width:50px; min-height: 2em;">
                        <div class="thrv_wrapper thrv_columns" style="margin-top: 0;margin-bottom: 0;">
                            ...
                            <div class="tve_colm tve_twc tve_lst">
                                <p style="color: #333333; font-size: 24px; margin-top: 10px;margin-bottom: 0; padding-bottom: 0;">Time
                                    left:</p>
...
<div class="thrv_wrapper thrv_content_container_shortcode">
    <div class="tve_clear"></div>
    <div class="tve_center tve_content_inner" style="width: 950px;min-width:50px; min-height: 2em;">
        <h1 class="tve_p_center" style="color: #333333; font-size: 52px;margin-top: 50px;">Wanna Know More?</h1>
...
<div class="thrv_wrapper thrv_page_section tve_corner_ps" data-tve-style="1">
    <div class="out" style="background-color: #58a396">
        <div class="in lightSec">
            <div class="cck tve_clearfix">
                <p class="tve_p_center" style="color: #fff; font-size: 24px;line-height: 26px;margin-bottom: 0;margin-top: 10px;padding-bottom: 0;">
                    *
                    <font color="#275850">
                        <span class="italic_text">This is Photoshop's version  of Lorem Ipsum.</span>
                    </font>
                    Proin gravida nibh vel velit auctor aliquet.
                </p>
                <p class="tve_p_center" style="color: #fff; font-size: 24px;line-height: 26px;margin-bottom: 10px;padding-bottom: 0;">
                    <span class="underline_text"><span class="bold_text">Aenean sollicitudin, lorem quis bibendum auctor,</span></span> nisi elit consequat ipsum.*
                </p>
            </div>
        </div>
    </div>
