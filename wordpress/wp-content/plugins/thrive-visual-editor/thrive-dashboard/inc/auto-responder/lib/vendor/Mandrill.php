...
class Thrive_Dash_Api_Mandrill
{
    ...
    public function __construct($apikey = null)
    {
        ...
        if (!$apikey) throw new Thrive_Dash_Api_Mandrill_Exceptions('You must provide a Mandrill API key');
        $this->apikey = $apikey;
    ...
    public function call($url, $params)
    {
        ...
        if ($result === null) throw new Thrive_Dash_Api_Mandrill_Exceptions('We were unable to decode the JSON response from the Mandrill API: ' . $result['body']);
