...
function woo_add_googlefonts () {
	global $google_fonts;
	$google_fonts[] = array( 'name' => 'Titillium Web', 'variant' => ':400,400italic,600,600italic,700,700italic' );
}
...
// Header search form
add_action( 'woo_nav_before', 'woo_header_search', 30 );

function woo_header_search() {
	global $woo_options;
