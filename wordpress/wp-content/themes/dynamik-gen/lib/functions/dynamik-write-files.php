...
/**
* Create the active Dynamik Skin style.css file if it does not already exist.
*
* @since 1.9
*
*/
function dynamik_create_active_skin_styles_file( $code = '' )
{
	if( file_exists( dynamik_get_active_skin_folder_path() . '/style.css' ) )
		return;
		
	$handle = @fopen( dynamik_get_active_skin_folder_path() . '/style.css', 'w' );
	@fwrite( $handle, $code );
	@fclose( $handle );
}

/**
* Write to the active Dynamik Skin style.css file if it exists.
*
* @since 1.9
*
*/
function dynamik_write_active_skin_styles( $code )
{
	dynamik_folders_open_permissions();
	if( !file_exists( dynamik_get_active_skin_folder_path() . '/style.css' ) )
	{
		dynamik_create_active_skin_styles_file();
	}
	...
	wp_redirect( admin_url( 'admin.php?page=dynamik-design&activetab=dynamik-design-options-nav-skins&notice=skin-file-updated' ) );
	exit();
}

/**
* Create the active Dynamik Skin functions.php file if it does not already exist.
*
* @since 1.9
*
*/
function dynamik_create_active_skin_functions_file( $code = '' )
{
	if( file_exists( dynamik_get_active_skin_folder_path() . '/functions.php' ) )
		return;
		
	$handle = @fopen( dynamik_get_active_skin_folder_path() . '/functions.php', 'w' );
	@fwrite( $handle, $code );
	@fclose( $handle );
}

/**
* Write to the active Dynamik Skin functions.php file if it exists.
*
* @since 1.9
*
*/
function dynamik_write_active_skin_functions( $code )
{
	dynamik_folders_open_permissions();
	if( !file_exists( dynamik_get_active_skin_folder_path() . '/functions.php' ) )
	{
		dynamik_create_active_skin_functions_file();
	}
...
/**
* Create the active Dynamik Skin scripts.js file if it does not already exist.
*
* @since 1.9
*
*/
function dynamik_create_active_skin_scripts_file( $code = '' )
{
	if( file_exists( dynamik_get_active_skin_folder_path() . '/scripts.js' ) )
		return;
		
	$handle = @fopen( dynamik_get_active_skin_folder_path() . '/scripts.js', 'w' );
	@fwrite( $handle, $code );
	@fclose( $handle );
}
...
*
*/
function dynamik_write_active_skin_scripts( $code )
{
	dynamik_folders_open_permissions();
	if( !file_exists( dynamik_get_active_skin_folder_path() . '/scripts.js' ) )
	{
		dynamik_create_active_skin_scripts_file();
	}
