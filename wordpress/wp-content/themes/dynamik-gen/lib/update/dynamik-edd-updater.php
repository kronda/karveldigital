...
function dynamik_sl_theme_updater()
{
	...
	$edd_updater = new EDD_SL_Theme_Updater( array(
			...
			'version' 			=> '1.9.6', 				// The current theme version we are running
			...
			<form method="post" action="options.php">
				...
				<div class="bg-box">
					<p>
						...
						<input id="dynamik_gen_license_key" name="dynamik_gen_license_key" type="password" class="regular-text" value="<?php echo esc_attr( $license ); ?>" style="width:100%; max-width:300px;"/>
...
function dynamik_activate_license()
{
	if( isset( $_POST['dynamik_license_activate'] ) ) {
		...
		$response = wp_remote_post( DYN_COBALT_APPS_URL, array( 'timeout' => 15, 'sslverify' => false, 'body' => $api_params ) );
